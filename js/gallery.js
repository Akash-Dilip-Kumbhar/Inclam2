  ...
  (function (t, e) {
    ...
    function r(e) {
      if (
        ...
        var I = t(r.height);
        return (
          !1 !== I && (a.height = I + (w ? 0 : g + b)),
          (a.innerWidth = a.width - (m + x)),
    ...
    i.extend(a, {
      ...
      open: function (t, e) {
        if (t && (i.isPlainObject(e) || (e = {}), !1 !== a.close(!0)))
          return (
              ...
              "object" === i.type(r) &&
                ...
                d(r)
                  ? ((p = {
                    ...
                    i.metadata && i.extend(!0, p, r.metadata()))
                  : (p = r)),
                (s = e.href || p.href || (c(r) ? r : null)),
                (h = e.title !== n ? e.title : p.title || ""),
                !(u = (l = e.content || p.content)
                  ? "html"
                  : e.type || p.type) &&
                  p.isDom &&
                  ((u = r.data("fancybox-type")) ||
                    (u = (u = r.prop("class").match(/fancybox\.(\w+)/))
                      ? u[1]
                      : null)),
                c(s) &&
                  (u ||
            ...
            e.keys !== n &&
              (a.opts.keys = !!e.keys && i.extend({}, a.defaults.keys, e.keys)),
            (a.group = t),
        ...
        return (
          e
            ...
            : ((i.w = u && t.innerWidth ? t.innerWidth : r.width()),
              (i.h = u && t.innerHeight ? t.innerHeight : r.height())),
          i
        );
      },
      unbindEvents: function () {
        a.wrap && d(a.wrap) && a.wrap.unbind(".fb"),
          s.unbind(".fb"),
          r.unbind(".fb");
      },
      bindEvents: function () {
          ...
          o.helpers &&
            i.each(o.helpers, function (e, n) {
              n &&
                ...
                a.helpers[e][t](i.extend(!0, {}, a.helpers[e].defaults, n), o);
            }),
            s.trigger(t);
        }
      },
      ...
      _afterLoad: function () {
        ...
        if ((a.hideLoading(), s && !1 !== a.isActive))
          if (!1 === a.trigger("afterLoad", s, h))
            s.wrap.stop(!0).trigger("onReset").remove(), (a.coming = null);
          else {
            switch (
              (h &&
                (a.trigger("beforeChange", h),
                h.wrap
                  .stop(!0)
            ...
            (!d(t) || !t.parent().is(s.inner)) && s.inner.append(t),
              ...
              a.bindEvents(),
              a.isOpened
                ? h.prevMethod && a.transitions[h.prevMethod]()
                : i(".fancybox-wrap")
                    .not(s.wrap)
                    .stop(!0)
                    .trigger("onReset")
      ...
      _setDimension: function () {
        ...
        if (
          (g
            ...
            .height("auto")
            .removeClass("fancybox-tmp"),
          (C = p(v.outerWidth(!0) - v.width())),
          (t = p(v.outerHeight(!0) - v.height())),
          (e = T + C),
          (n = W + t),
          (o = f(y) ? ((d.w - e) * p(y)) / 100 : y),
          (r = f(w) ? ((d.h - n) * p(w)) / 100 : w),
          "iframe" === b.type)
        ) {
          if (((u = b.content), b.autoHeight && 1 === u.data("ready")))
            try {
          ...
          (b.autoWidth || b.autoHeight) &&
            ...
            b.autoWidth || x.width(o),
            b.autoHeight || x.height(r),
            b.autoWidth && (o = x.width()),
            b.autoHeight && (r = x.height()),
        ...
        if (
          ...
          (h = S),
          b.fitToView &&
            ((z = Math.min(d.w - e, z)), (S = Math.min(d.h - n, S))),
          (e = d.w - T),
          (W = d.h - W),
          b.aspectRatio
            ? (y > z && ((y = z), (w = p(y / l))),
              ...
              y < _ && ((y = _), (w = p(y / l))),
              w < I && ((w = I), (y = p(w * l))))
            : ((y = Math.max(_, Math.min(y, z))),
              b.autoHeight &&
                "iframe" !== b.type &&
                (x.width(y), (w = x.height())),
              (w = Math.max(I, Math.min(w, S)))),
          b.fitToView)
        )
          if (
            (x.width(y).height(w),
            ...
            for (; (d > e || T > W) && y > _ && w > I && !(19 < c++); )
              (w = Math.max(I, Math.min(S, w - 10))),
                (y = p(w * l)) < _ && ((y = _), (w = p(y / l))),
                y > z && ((y = z), (w = p(y / l))),
                x.width(y).height(w),
                g.width(y + C),
                (d = g.width()),
            ...
            (y = Math.max(_, Math.min(y, y - (d - e)))),
              (w = Math.max(I, Math.min(w, w - (T - W))));
        L && "auto" === E && w < r && y + C + L < e && (y += L),
          x.width(y).height(w),
          g.width(y + C),
          (d = g.width()),
          (T = g.height()),
      ...
      _getPosition: function (t) {
        ...
        return (
          ...
          (n.top = m(Math.max(n.top, n.top + (i.h - r) * e.topRatio))),
      ...
      _afterZoomIn: function () {
        ...
        t &&
          ...
          t.arrows &&
            1 < a.group.length &&
            ((t.loop || 0 < t.index) &&
              i(t.tpl.prev).appendTo(a.outer).bind("click.fb", a.prev),
            (t.loop || t.index < a.group.length - 1) &&
              i(t.tpl.next).appendTo(a.outer).bind("click.fb", a.next)),
          a.trigger("afterShow"),
      ...
      (a.transitions = {
        getOrigPosition: function () {
          ...
          return (
            ...
            d(i)
              ...
              : ((n.top = l.y + (l.h - r) * t.topRatio),
                (n.left = l.x + (l.w - o) * t.leftRatio)),
        ...
        step: function (t, e) {
          ...
          ("width" !== o && "height" !== o) ||
            ...
            (n = t - n),
            a.skin[o](p("width" === o ? n : n - r * i)),
            a.inner[o](p("width" === o ? n : n - r * i - s * i)));
        },
        zoomIn: function () {
          var t = a.current,
            e = t.pos,
        ...
        create: function (t) {
          (t = i.extend({}, this.defaults, t)),
            ...
            (this.overlay = i('<div class="fancybox-overlay"></div>').appendTo(
              a.coming ? a.coming.parent : t.parent
            )),
            (this.fixed = !1),
            t.fixed &&
              a.defaults.fixed &&
        ...
        open: function (t) {
          ...
          (t = i.extend({}, this.defaults, t)),
            this.overlay
              ...
              : this.create(t),
            this.fixed ||
              (r.bind("resize.overlay", i.proxy(this.update, this)),
              this.update()),
            t.closeClick &&
              this.overlay.bind("click.overlay", function (t) {
                if (i(t.target).hasClass("fancybox-overlay"))
                  return a.isActive ? a.close() : e.close(), !1;
              }),
            ...
            switch (
              ...
              default:
                (o = a.skin),
                  ...
                  (a.current.margin[2] += Math.abs(p(e.css("margin-bottom"))));
            }
      ...
      s.ready(function () {
        ...
        if (
          ...
          var s =
            20 ===
              (r = i('<div style="position:fixed;top:20px;"></div>').appendTo(
                "body"
              ))[0].offsetTop || 15 === r[0].offsetTop;
  ...
  (function (t) {
    ...
    function e(e) {
      ...
      if (
        ...
        (l = 0 === c ? d : c),
        "deltaY" in s && ((c = -1 * s.deltaY), (l = c)),
        "deltaX" in s && ((d = s.deltaX), 0 === c && (l = -1 * d)),
        0 !== c || 0 !== d)
      ) {
        if (1 === s.deltaMode) {
        ...
        if (
          ((f = Math.max(Math.abs(c), Math.abs(d))),
          (!r || r > f) && ((r = f), n(s, f) && (r /= 40)),
          n(s, f) && ((l /= 40), (d /= 40), (c /= 40)),
